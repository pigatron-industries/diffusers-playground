...
class ImageDiffusionConditioningRoomDecorWorkflow(WorkflowBuilder):
    ...
    """
    Image diffusion with a set of fixed conditioning models for changing decor of room while keep room dimensions intact.
    Uses MLSD straight line and segmentation control nets as conditioning.
    MLSD controlnet is only available for SD1.5 models.
    """
