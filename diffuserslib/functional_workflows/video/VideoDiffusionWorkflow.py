...
class VideoDiffusionWorkflow(WorkflowBuilder):
    ...
    def build(self):
        model_input = DiffusionModelUserInputNode(basemodels=["svd_1_0", "cogvideox_t2v", "cogvideox_i2v", "cogvideox_v2v"], modeltype="video", name="model")
        ...
        image_input = ImageUploadInputNode(mandatory = False, name = "image")
